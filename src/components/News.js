...
export class News extends Component {
  ...
  async updateNews(){
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4fa506642d994a779b08e83c65459c6b&page=${this.state.page}&pageSize=${this.props.pageSize}`
  ...
  render() {
    ...
    return (
      ...
      <h1 className="text-center">DailyNews - Top Headlines from {this.capitalize(this.props.category)}</h1>
